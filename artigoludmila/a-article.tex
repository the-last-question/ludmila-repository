...
Dentro de sua estrutura de entradas e saídas ela possui duas portas de comunicação serial que utilizam o protocolo UART (Universal asynchronous receiver/transmitter), 
